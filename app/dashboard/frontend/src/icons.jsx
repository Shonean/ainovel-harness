...
export function CacheIcon(props) {
    return (
        <IconBase {...props}>
            <path d="M21 8V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v1m0 0c0 1.1.9 2 2 2h14a2 2 0 0 0 2-2zm-8 2v11m-5 0h10" />
        </IconBase>
    )
}
...
export function HistoryIcon(props) {
    return (
        <IconBase {...props}>
            <rect x="5" y="5" width="2" height="12" />
            <rect x="10" y="3" width="2" height="14" />
...
export function RocketIcon(props) {
    return (
        <IconBase {...props}>
            ...
            <rect x="9" y="5" width="6" height="8" />
            <rect x="6" y="10" width="3" height="5" />
            <rect x="15" y="10" width="3" height="5" />
