...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "load_user_env": (".config", "load_user_env"),
    # API Client
    ...
    "ContextRanker": (".context_manager", "ContextRanker"),
    "QueryRouter": (".rag_adapter", "QueryRouter"),
    # Style Sampler
    ...
    # Memory Contract
    "MemoryContract": (".memory_contract_adapter", "MemoryContract"),
