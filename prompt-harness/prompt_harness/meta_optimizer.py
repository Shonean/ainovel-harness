...
# 统一的参考目标文本
_REF_TARGET = (
    "陈迹推开铁门，雨声灌了进来。他抖了抖雨衣上的水珠，把伞收拢靠在墙边。"
    "「病历呢？」他伸出手。一份档案袋从身后递了过来，边角已经被雨水洇湿了一小块。"
    "陈迹翻开病历，眉头渐渐皱了起来。「什么时候的事？」"
    "「三天前。」身后的声音有些紧张。"
    "陈迹没回头。他知道身后的脚步声会一直跟着他走进六楼。"
